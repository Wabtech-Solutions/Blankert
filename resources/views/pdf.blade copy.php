    ...
    <div class="center">
        <div id="offer-style" class="offer">
                        ...
                        <div class="container">
                            <div class="offer-title">
                                <h1 style="padding-top: 10px;">
                                    {{ $Merkauto3 . ' ' . $Typeauto3 . ' ' . $Uitvoeringauto3 }}
                                </h1>
                            </div>
                            <div class="offerte-img"> <img width="200px" style="border-radius: 10px;"
            ...
            <div class="offer-item">
                ...
                {{-- <div class="footer">
            <div class="center">
                <p class="footer-text">Tarieven zijn exclusief BTW indien niet anders vermeld. <br>Prijzen zijn onder
                    voorbehoud van prijswijzigingen en typfouten.<br> Deze offerte
                    is geldig tot en met @php
                        use Carbon\Carbon;

                        $currentDate = Carbon::now()->startOfDay();
                        $newDate = $currentDate->addDays(7)->format('d/m/Y');

                    @endphp <b> {{ $newDate }} </b>.</p>
            </div>
        </div> --}}
...
<div id="page1" class="page">
    ...
    <div class="center">
        <div id="offer-style" class="offer2">
